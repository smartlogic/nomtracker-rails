...
class StoryHelper
  ...
  def self.load_data
    ...
    adam= User.create!(:name => "Adam", :password => 'adamadam',:password_confirmation => 'adamadam', :email => "adam@slsdev.net")
    nick= User.create!(:name => "Nick", :password => 'nicknick', :password_confirmation => 'nicknick', :email => "nick@slsdev.net")
    michael= User.create!(:name => "Michael", :password => 'mikemike', :password_confirmation => 'mikemike', :email => "mike@slsdev.net")
